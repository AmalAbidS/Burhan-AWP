...
// Temporary userID and roleID for testing
$_SESSION['userID'] = 2; // Replace with a valid userID from your database
$_SESSION['roleID'] = 2; // Replace with 1 for admin, 2 for detective, etc.
...
.case-container {
    ...
    width: 100%;
    max-width: 1400px; /* Optional: Adjust container width */
...
.case-container h1 {
            ...
            color: #ffcc00; /* Match color scheme */
...
.case-card:hover {
    ...
    box-shadow: 0 6px 10px rgba(0, 0, 0, 0.4); /* Shadow on hover */
    background-color: #354a5f; /* Lighter background */
}
...
.case-card-link {
    ...
    display: block; /* Make link wrap around the card */
}
